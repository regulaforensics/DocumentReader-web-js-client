...
export enum TextFieldType {
  ...
  */
  FT_LAST_NAME = 650,
  /**
   * Validity date of RM driver’s license
   */
  DL_CLASS_CODE_RM_FROM = 651,
  /**
   * Restrictions date of RM driver’s license
   */
  DL_CLASS_CODE_RM_NOTES = 652,
  /**
   * Expiration date of RM driver’s license
   */
  DL_CLASS_CODE_RM_TO = 653,
  /**
   * Validity date of PW driver’s license
   */
  DL_CLASS_CODE_PW_FROM = 654,
  /**
   * Restrictions date of PW driver’s license
   */
  DL_CLASS_CODE_PW_NOTES = 655,
  /**
   * Expiration date of PW driver’s license
   */
