...
export interface ContainerList {
    /**
     * 
     * @type {Array<StatusResult | ImageQualityListResult | TextResult | DocumentImageResult | ImagesResult | ChosenDocumentTypeResult | DocumentTypesCandidatesResult | TextDataResult | GraphicsResult | LexicalAnalysisResult | AuthenticityResult>}
     * @memberof ContainerList
     */
    List: Array<StatusResult | ImageQualityListResult | TextResult | DocumentImageResult | ImagesResult | ChosenDocumentTypeResult | DocumentTypesCandidatesResult | TextDataResult | GraphicsResult | LexicalAnalysisResult | AuthenticityResult>;
}
