...
export const DocumentTypeRecognitionResult = {
    /**
...
export type DocumentTypeRecognitionResult = typeof DocumentTypeRecognitionResult[keyof typeof DocumentTypeRecognitionResult];
