...
import type { DocVisualExtendedFieldRectAllOf } from './doc-visual-extended-field-rect-all-of';
 ...
 * @export
 */
export type DocVisualExtendedFieldRect = DocVisualExtendedField & DocVisualExtendedFieldRectAllOf;
