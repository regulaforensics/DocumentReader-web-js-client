...
import type { DocumentBinaryInfoResultAllOf } from './document-binary-info-result-all-of';
 ...
 * @export
 */
export type DocumentBinaryInfoResult = DocumentBinaryInfoResultAllOf & ResultItem;
